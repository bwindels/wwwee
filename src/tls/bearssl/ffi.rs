// bindgen lib/BearSSL/inc/bearssl.h --whitelist-var=BR_.+ --whitelist-function=br_.+ --whitelist-type=br_.+ --no-layout-tests --no-derive-copy --no-derive-debug | rustfmt > ffi.rs
/* automatically generated by rust-bindgen */

pub const BR_HASHDESC_ID_OFF: ::std::os::raw::c_uint = 0;
pub const BR_HASHDESC_ID_MASK: ::std::os::raw::c_uint = 255;
pub const BR_HASHDESC_OUT_OFF: ::std::os::raw::c_uint = 8;
pub const BR_HASHDESC_OUT_MASK: ::std::os::raw::c_uint = 127;
pub const BR_HASHDESC_STATE_OFF: ::std::os::raw::c_uint = 15;
pub const BR_HASHDESC_STATE_MASK: ::std::os::raw::c_uint = 255;
pub const BR_HASHDESC_LBLEN_OFF: ::std::os::raw::c_uint = 23;
pub const BR_HASHDESC_LBLEN_MASK: ::std::os::raw::c_uint = 15;
pub const BR_EC_sect163k1: ::std::os::raw::c_uint = 1;
pub const BR_EC_sect163r1: ::std::os::raw::c_uint = 2;
pub const BR_EC_sect163r2: ::std::os::raw::c_uint = 3;
pub const BR_EC_sect193r1: ::std::os::raw::c_uint = 4;
pub const BR_EC_sect193r2: ::std::os::raw::c_uint = 5;
pub const BR_EC_sect233k1: ::std::os::raw::c_uint = 6;
pub const BR_EC_sect233r1: ::std::os::raw::c_uint = 7;
pub const BR_EC_sect239k1: ::std::os::raw::c_uint = 8;
pub const BR_EC_sect283k1: ::std::os::raw::c_uint = 9;
pub const BR_EC_sect283r1: ::std::os::raw::c_uint = 10;
pub const BR_EC_sect409k1: ::std::os::raw::c_uint = 11;
pub const BR_EC_sect409r1: ::std::os::raw::c_uint = 12;
pub const BR_EC_sect571k1: ::std::os::raw::c_uint = 13;
pub const BR_EC_sect571r1: ::std::os::raw::c_uint = 14;
pub const BR_EC_secp160k1: ::std::os::raw::c_uint = 15;
pub const BR_EC_secp160r1: ::std::os::raw::c_uint = 16;
pub const BR_EC_secp160r2: ::std::os::raw::c_uint = 17;
pub const BR_EC_secp192k1: ::std::os::raw::c_uint = 18;
pub const BR_EC_secp192r1: ::std::os::raw::c_uint = 19;
pub const BR_EC_secp224k1: ::std::os::raw::c_uint = 20;
pub const BR_EC_secp224r1: ::std::os::raw::c_uint = 21;
pub const BR_EC_secp256k1: ::std::os::raw::c_uint = 22;
pub const BR_EC_secp256r1: ::std::os::raw::c_uint = 23;
pub const BR_EC_secp384r1: ::std::os::raw::c_uint = 24;
pub const BR_EC_secp521r1: ::std::os::raw::c_uint = 25;
pub const BR_EC_brainpoolP256r1: ::std::os::raw::c_uint = 26;
pub const BR_EC_brainpoolP384r1: ::std::os::raw::c_uint = 27;
pub const BR_EC_brainpoolP512r1: ::std::os::raw::c_uint = 28;
pub const BR_EC_curve25519: ::std::os::raw::c_uint = 29;
pub const BR_EC_curve448: ::std::os::raw::c_uint = 30;
pub const BR_ERR_X509_OK: ::std::os::raw::c_uint = 32;
pub const BR_ERR_X509_INVALID_VALUE: ::std::os::raw::c_uint = 33;
pub const BR_ERR_X509_TRUNCATED: ::std::os::raw::c_uint = 34;
pub const BR_ERR_X509_EMPTY_CHAIN: ::std::os::raw::c_uint = 35;
pub const BR_ERR_X509_INNER_TRUNC: ::std::os::raw::c_uint = 36;
pub const BR_ERR_X509_BAD_TAG_CLASS: ::std::os::raw::c_uint = 37;
pub const BR_ERR_X509_BAD_TAG_VALUE: ::std::os::raw::c_uint = 38;
pub const BR_ERR_X509_INDEFINITE_LENGTH: ::std::os::raw::c_uint = 39;
pub const BR_ERR_X509_EXTRA_ELEMENT: ::std::os::raw::c_uint = 40;
pub const BR_ERR_X509_UNEXPECTED: ::std::os::raw::c_uint = 41;
pub const BR_ERR_X509_NOT_CONSTRUCTED: ::std::os::raw::c_uint = 42;
pub const BR_ERR_X509_NOT_PRIMITIVE: ::std::os::raw::c_uint = 43;
pub const BR_ERR_X509_PARTIAL_BYTE: ::std::os::raw::c_uint = 44;
pub const BR_ERR_X509_BAD_BOOLEAN: ::std::os::raw::c_uint = 45;
pub const BR_ERR_X509_OVERFLOW: ::std::os::raw::c_uint = 46;
pub const BR_ERR_X509_BAD_DN: ::std::os::raw::c_uint = 47;
pub const BR_ERR_X509_BAD_TIME: ::std::os::raw::c_uint = 48;
pub const BR_ERR_X509_UNSUPPORTED: ::std::os::raw::c_uint = 49;
pub const BR_ERR_X509_LIMIT_EXCEEDED: ::std::os::raw::c_uint = 50;
pub const BR_ERR_X509_WRONG_KEY_TYPE: ::std::os::raw::c_uint = 51;
pub const BR_ERR_X509_BAD_SIGNATURE: ::std::os::raw::c_uint = 52;
pub const BR_ERR_X509_TIME_UNKNOWN: ::std::os::raw::c_uint = 53;
pub const BR_ERR_X509_EXPIRED: ::std::os::raw::c_uint = 54;
pub const BR_ERR_X509_DN_MISMATCH: ::std::os::raw::c_uint = 55;
pub const BR_ERR_X509_BAD_SERVER_NAME: ::std::os::raw::c_uint = 56;
pub const BR_ERR_X509_CRITICAL_EXTENSION: ::std::os::raw::c_uint = 57;
pub const BR_ERR_X509_NOT_CA: ::std::os::raw::c_uint = 58;
pub const BR_ERR_X509_FORBIDDEN_KEY_USAGE: ::std::os::raw::c_uint = 59;
pub const BR_ERR_X509_WEAK_PUBLIC_KEY: ::std::os::raw::c_uint = 60;
pub const BR_ERR_X509_NOT_TRUSTED: ::std::os::raw::c_uint = 62;
pub const BR_X509_TA_CA: ::std::os::raw::c_uint = 1;
pub const BR_KEYTYPE_RSA: ::std::os::raw::c_uint = 1;
pub const BR_KEYTYPE_EC: ::std::os::raw::c_uint = 2;
pub const BR_KEYTYPE_KEYX: ::std::os::raw::c_uint = 16;
pub const BR_KEYTYPE_SIGN: ::std::os::raw::c_uint = 32;
pub const BR_X509_BUFSIZE_KEY: ::std::os::raw::c_uint = 520;
pub const BR_X509_BUFSIZE_SIG: ::std::os::raw::c_uint = 512;
pub const BR_SSL_BUFSIZE_INPUT: ::std::os::raw::c_uint = 16709;
pub const BR_SSL_BUFSIZE_OUTPUT: ::std::os::raw::c_uint = 16469;
pub const BR_SSL_BUFSIZE_MONO: ::std::os::raw::c_uint = 16709;
pub const BR_SSL_BUFSIZE_BIDI: ::std::os::raw::c_uint = 33178;
pub const BR_SSL30: ::std::os::raw::c_uint = 768;
pub const BR_TLS10: ::std::os::raw::c_uint = 769;
pub const BR_TLS11: ::std::os::raw::c_uint = 770;
pub const BR_TLS12: ::std::os::raw::c_uint = 771;
pub const BR_ERR_OK: ::std::os::raw::c_uint = 0;
pub const BR_ERR_BAD_PARAM: ::std::os::raw::c_uint = 1;
pub const BR_ERR_BAD_STATE: ::std::os::raw::c_uint = 2;
pub const BR_ERR_UNSUPPORTED_VERSION: ::std::os::raw::c_uint = 3;
pub const BR_ERR_BAD_VERSION: ::std::os::raw::c_uint = 4;
pub const BR_ERR_BAD_LENGTH: ::std::os::raw::c_uint = 5;
pub const BR_ERR_TOO_LARGE: ::std::os::raw::c_uint = 6;
pub const BR_ERR_BAD_MAC: ::std::os::raw::c_uint = 7;
pub const BR_ERR_NO_RANDOM: ::std::os::raw::c_uint = 8;
pub const BR_ERR_UNKNOWN_TYPE: ::std::os::raw::c_uint = 9;
pub const BR_ERR_UNEXPECTED: ::std::os::raw::c_uint = 10;
pub const BR_ERR_BAD_CCS: ::std::os::raw::c_uint = 12;
pub const BR_ERR_BAD_ALERT: ::std::os::raw::c_uint = 13;
pub const BR_ERR_BAD_HANDSHAKE: ::std::os::raw::c_uint = 14;
pub const BR_ERR_OVERSIZED_ID: ::std::os::raw::c_uint = 15;
pub const BR_ERR_BAD_CIPHER_SUITE: ::std::os::raw::c_uint = 16;
pub const BR_ERR_BAD_COMPRESSION: ::std::os::raw::c_uint = 17;
pub const BR_ERR_BAD_FRAGLEN: ::std::os::raw::c_uint = 18;
pub const BR_ERR_BAD_SECRENEG: ::std::os::raw::c_uint = 19;
pub const BR_ERR_EXTRA_EXTENSION: ::std::os::raw::c_uint = 20;
pub const BR_ERR_BAD_SNI: ::std::os::raw::c_uint = 21;
pub const BR_ERR_BAD_HELLO_DONE: ::std::os::raw::c_uint = 22;
pub const BR_ERR_LIMIT_EXCEEDED: ::std::os::raw::c_uint = 23;
pub const BR_ERR_BAD_FINISHED: ::std::os::raw::c_uint = 24;
pub const BR_ERR_RESUME_MISMATCH: ::std::os::raw::c_uint = 25;
pub const BR_ERR_INVALID_ALGORITHM: ::std::os::raw::c_uint = 26;
pub const BR_ERR_BAD_SIGNATURE: ::std::os::raw::c_uint = 27;
pub const BR_ERR_WRONG_KEY_USAGE: ::std::os::raw::c_uint = 28;
pub const BR_ERR_NO_CLIENT_AUTH: ::std::os::raw::c_uint = 29;
pub const BR_ERR_IO: ::std::os::raw::c_uint = 31;
pub const BR_ERR_RECV_FATAL_ALERT: ::std::os::raw::c_uint = 256;
pub const BR_ERR_SEND_FATAL_ALERT: ::std::os::raw::c_uint = 512;
pub const BR_MAX_CIPHER_SUITES: ::std::os::raw::c_uint = 40;
pub const BR_SSL_CLOSED: ::std::os::raw::c_uint = 1;
pub const BR_SSL_SENDREC: ::std::os::raw::c_uint = 2;
pub const BR_SSL_RECVREC: ::std::os::raw::c_uint = 4;
pub const BR_SSL_SENDAPP: ::std::os::raw::c_uint = 8;
pub const BR_SSL_RECVAPP: ::std::os::raw::c_uint = 16;
pub const BR_AUTH_ECDH: ::std::os::raw::c_uint = 0;
pub const BR_AUTH_RSA: ::std::os::raw::c_uint = 1;
pub const BR_AUTH_ECDSA: ::std::os::raw::c_uint = 3;
pub const BR_SSLKEYX_RSA: ::std::os::raw::c_uint = 0;
pub const BR_SSLKEYX_ECDHE_RSA: ::std::os::raw::c_uint = 1;
pub const BR_SSLKEYX_ECDHE_ECDSA: ::std::os::raw::c_uint = 2;
pub const BR_SSLKEYX_ECDH_RSA: ::std::os::raw::c_uint = 3;
pub const BR_SSLKEYX_ECDH_ECDSA: ::std::os::raw::c_uint = 4;
pub const BR_SSLENC_3DES_CBC: ::std::os::raw::c_uint = 0;
pub const BR_SSLENC_AES128_CBC: ::std::os::raw::c_uint = 1;
pub const BR_SSLENC_AES256_CBC: ::std::os::raw::c_uint = 2;
pub const BR_SSLENC_AES128_GCM: ::std::os::raw::c_uint = 3;
pub const BR_SSLENC_AES256_GCM: ::std::os::raw::c_uint = 4;
pub const BR_SSLENC_CHACHA20: ::std::os::raw::c_uint = 5;
pub const BR_SSLMAC_AEAD: ::std::os::raw::c_uint = 0;
pub const BR_SSLMAC_SHA1: ::std::os::raw::c_uint = 2;
pub const BR_SSLMAC_SHA256: ::std::os::raw::c_uint = 4;
pub const BR_SSLMAC_SHA384: ::std::os::raw::c_uint = 5;
pub const BR_SSLPRF_SHA256: ::std::os::raw::c_uint = 4;
pub const BR_SSLPRF_SHA384: ::std::os::raw::c_uint = 5;
pub const BR_TLS_NULL_WITH_NULL_NULL: ::std::os::raw::c_uint = 0;
pub const BR_TLS_RSA_WITH_NULL_MD5: ::std::os::raw::c_uint = 1;
pub const BR_TLS_RSA_WITH_NULL_SHA: ::std::os::raw::c_uint = 2;
pub const BR_TLS_RSA_WITH_NULL_SHA256: ::std::os::raw::c_uint = 59;
pub const BR_TLS_RSA_WITH_RC4_128_MD5: ::std::os::raw::c_uint = 4;
pub const BR_TLS_RSA_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 5;
pub const BR_TLS_RSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 10;
pub const BR_TLS_RSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 47;
pub const BR_TLS_RSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 53;
pub const BR_TLS_RSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 60;
pub const BR_TLS_RSA_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 61;
pub const BR_TLS_DH_DSS_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 13;
pub const BR_TLS_DH_RSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 16;
pub const BR_TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 19;
pub const BR_TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 22;
pub const BR_TLS_DH_DSS_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 48;
pub const BR_TLS_DH_RSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49;
pub const BR_TLS_DHE_DSS_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 50;
pub const BR_TLS_DHE_RSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 51;
pub const BR_TLS_DH_DSS_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 54;
pub const BR_TLS_DH_RSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 55;
pub const BR_TLS_DHE_DSS_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 56;
pub const BR_TLS_DHE_RSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 57;
pub const BR_TLS_DH_DSS_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 62;
pub const BR_TLS_DH_RSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 63;
pub const BR_TLS_DHE_DSS_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 64;
pub const BR_TLS_DHE_RSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 103;
pub const BR_TLS_DH_DSS_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 104;
pub const BR_TLS_DH_RSA_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 105;
pub const BR_TLS_DHE_DSS_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 106;
pub const BR_TLS_DHE_RSA_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 107;
pub const BR_TLS_DH_anon_WITH_RC4_128_MD5: ::std::os::raw::c_uint = 24;
pub const BR_TLS_DH_anon_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 27;
pub const BR_TLS_DH_anon_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 52;
pub const BR_TLS_DH_anon_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 58;
pub const BR_TLS_DH_anon_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 108;
pub const BR_TLS_DH_anon_WITH_AES_256_CBC_SHA256: ::std::os::raw::c_uint = 109;
pub const BR_TLS_ECDH_ECDSA_WITH_NULL_SHA: ::std::os::raw::c_uint = 49153;
pub const BR_TLS_ECDH_ECDSA_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 49154;
pub const BR_TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 49155;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49156;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 49157;
pub const BR_TLS_ECDHE_ECDSA_WITH_NULL_SHA: ::std::os::raw::c_uint = 49158;
pub const BR_TLS_ECDHE_ECDSA_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 49159;
pub const BR_TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 49160;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49161;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 49162;
pub const BR_TLS_ECDH_RSA_WITH_NULL_SHA: ::std::os::raw::c_uint = 49163;
pub const BR_TLS_ECDH_RSA_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 49164;
pub const BR_TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 49165;
pub const BR_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49166;
pub const BR_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 49167;
pub const BR_TLS_ECDHE_RSA_WITH_NULL_SHA: ::std::os::raw::c_uint = 49168;
pub const BR_TLS_ECDHE_RSA_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 49169;
pub const BR_TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 49170;
pub const BR_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49171;
pub const BR_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 49172;
pub const BR_TLS_ECDH_anon_WITH_NULL_SHA: ::std::os::raw::c_uint = 49173;
pub const BR_TLS_ECDH_anon_WITH_RC4_128_SHA: ::std::os::raw::c_uint = 49174;
pub const BR_TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA: ::std::os::raw::c_uint = 49175;
pub const BR_TLS_ECDH_anon_WITH_AES_128_CBC_SHA: ::std::os::raw::c_uint = 49176;
pub const BR_TLS_ECDH_anon_WITH_AES_256_CBC_SHA: ::std::os::raw::c_uint = 49177;
pub const BR_TLS_RSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 156;
pub const BR_TLS_RSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 157;
pub const BR_TLS_DHE_RSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 158;
pub const BR_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 159;
pub const BR_TLS_DH_RSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 160;
pub const BR_TLS_DH_RSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 161;
pub const BR_TLS_DHE_DSS_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 162;
pub const BR_TLS_DHE_DSS_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 163;
pub const BR_TLS_DH_DSS_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 164;
pub const BR_TLS_DH_DSS_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 165;
pub const BR_TLS_DH_anon_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 166;
pub const BR_TLS_DH_anon_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 167;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 49187;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384: ::std::os::raw::c_uint = 49188;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 49189;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384: ::std::os::raw::c_uint = 49190;
pub const BR_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 49191;
pub const BR_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384: ::std::os::raw::c_uint = 49192;
pub const BR_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256: ::std::os::raw::c_uint = 49193;
pub const BR_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384: ::std::os::raw::c_uint = 49194;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 49195;
pub const BR_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 49196;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 49197;
pub const BR_TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 49198;
pub const BR_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 49199;
pub const BR_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 49200;
pub const BR_TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256: ::std::os::raw::c_uint = 49201;
pub const BR_TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384: ::std::os::raw::c_uint = 49202;
pub const BR_TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52392;
pub const BR_TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52393;
pub const BR_TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52394;
pub const BR_TLS_PSK_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52395;
pub const BR_TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52396;
pub const BR_TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52397;
pub const BR_TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256: ::std::os::raw::c_uint = 52398;
pub const BR_TLS_FALLBACK_SCSV: ::std::os::raw::c_uint = 22016;
pub const BR_ALERT_CLOSE_NOTIFY: ::std::os::raw::c_uint = 0;
pub const BR_ALERT_UNEXPECTED_MESSAGE: ::std::os::raw::c_uint = 10;
pub const BR_ALERT_BAD_RECORD_MAC: ::std::os::raw::c_uint = 20;
pub const BR_ALERT_RECORD_OVERFLOW: ::std::os::raw::c_uint = 22;
pub const BR_ALERT_DECOMPRESSION_FAILURE: ::std::os::raw::c_uint = 30;
pub const BR_ALERT_HANDSHAKE_FAILURE: ::std::os::raw::c_uint = 40;
pub const BR_ALERT_BAD_CERTIFICATE: ::std::os::raw::c_uint = 42;
pub const BR_ALERT_UNSUPPORTED_CERTIFICATE: ::std::os::raw::c_uint = 43;
pub const BR_ALERT_CERTIFICATE_REVOKED: ::std::os::raw::c_uint = 44;
pub const BR_ALERT_CERTIFICATE_EXPIRED: ::std::os::raw::c_uint = 45;
pub const BR_ALERT_CERTIFICATE_UNKNOWN: ::std::os::raw::c_uint = 46;
pub const BR_ALERT_ILLEGAL_PARAMETER: ::std::os::raw::c_uint = 47;
pub const BR_ALERT_UNKNOWN_CA: ::std::os::raw::c_uint = 48;
pub const BR_ALERT_ACCESS_DENIED: ::std::os::raw::c_uint = 49;
pub const BR_ALERT_DECODE_ERROR: ::std::os::raw::c_uint = 50;
pub const BR_ALERT_DECRYPT_ERROR: ::std::os::raw::c_uint = 51;
pub const BR_ALERT_PROTOCOL_VERSION: ::std::os::raw::c_uint = 70;
pub const BR_ALERT_INSUFFICIENT_SECURITY: ::std::os::raw::c_uint = 71;
pub const BR_ALERT_INTERNAL_ERROR: ::std::os::raw::c_uint = 80;
pub const BR_ALERT_USER_CANCELED: ::std::os::raw::c_uint = 90;
pub const BR_ALERT_NO_RENEGOTIATION: ::std::os::raw::c_uint = 100;
pub const BR_ALERT_UNSUPPORTED_EXTENSION: ::std::os::raw::c_uint = 110;
pub const BR_ALERT_NO_APPLICATION_PROTOCOL: ::std::os::raw::c_uint = 120;
pub const BR_PEM_BEGIN_OBJ: ::std::os::raw::c_uint = 1;
pub const BR_PEM_END_OBJ: ::std::os::raw::c_uint = 2;
pub const BR_PEM_ERROR: ::std::os::raw::c_uint = 3;
...
pub struct br_hash_class_ {
    ...
    pub out: ::std::option::Option<
        unsafe extern "C" fn(ctx: *const *const br_hash_class, dst: *mut ::std::os::raw::c_void),
    >,
...
extern "C" {
    ...
    /// \param data   pointer to the injected data.
    /// \param len    injected data length (in bytes).
    pub fn br_md5sha1_update(
        ctx: *mut br_md5sha1_context,
        data: *const ::std::os::raw::c_void,
        len: usize,
    );
}
...
pub type br_ghash = ::std::option::Option<
    unsafe extern "C" fn(
...
pub struct br_hmac_key_context {
    ...
    pub ksi: [::std::os::raw::c_uchar; 64usize],
    pub kso: [::std::os::raw::c_uchar; 64usize],
}
extern "C" {
...
pub type br_prng_seeder = ::std::option::Option<
    unsafe extern "C" fn(ctx: *mut *const br_prng_class) -> ::std::os::raw::c_int,
>;
extern "C" {
...
/// \param seed_num     number of seed chunks.
/// \param seed         seed chnks for this computation (usually non-secret).
pub type br_tls_prf_impl = ::std::option::Option<
    unsafe extern "C" fn(
        dst: *mut ::std::os::raw::c_void,
        len: usize,
        secret: *const ::std::os::raw::c_void,
...
pub struct br_block_ctrcbc_class_ {
    ...
    pub encrypt: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            ctr: *mut ::std::os::raw::c_void,
            cbcmac: *mut ::std::os::raw::c_void,
            data: *mut ::std::os::raw::c_void,
            len: usize,
        ),
    >,
...
extern "C" {
    ...
    /// \param key   secret key.
    /// \param len   secret key length (in bytes).
    pub fn br_aes_big_ctr_init(
        ctx: *mut br_aes_big_ctr_keys,
        key: *const ::std::os::raw::c_void,
        len: usize,
    );
}
...
extern "C" {
    ...
    /// \param key   secret key.
    /// \param len   secret key length (in bytes).
    pub fn br_aes_ct_ctr_init(
        ctx: *mut br_aes_ct_ctr_keys,
        key: *const ::std::os::raw::c_void,
        len: usize,
    );
}
...
/// \param data   data to encrypt or decrypt.
/// \param len    data length (in bytes).
pub type br_chacha20_run = ::std::option::Option<
    unsafe extern "C" fn(
        key: *const ::std::os::raw::c_void,
        iv: *const ::std::os::raw::c_void,
        cc: u32,
...
pub type br_poly1305_run = ::std::option::Option<
    unsafe extern "C" fn(
        key: *const ::std::os::raw::c_void,
        iv: *const ::std::os::raw::c_void,
        data: *mut ::std::os::raw::c_void,
        len: usize,
        aad: *const ::std::os::raw::c_void,
        aad_len: usize,
...
pub struct br_aead_class_ {
    ...
    pub aad_inject: ::std::option::Option<
        unsafe extern "C" fn(
            cc: *mut *const br_aead_class,
            data: *const ::std::os::raw::c_void,
            len: usize,
    ...
    pub get_tag: ::std::option::Option<
        unsafe extern "C" fn(cc: *mut *const br_aead_class, tag: *mut ::std::os::raw::c_void),
    >,
    ...
    pub check_tag: ::std::option::Option<
        unsafe extern "C" fn(cc: *mut *const br_aead_class, tag: *const ::std::os::raw::c_void)
            -> u32,
    >,
    ...
    pub get_tag_trunc: ::std::option::Option<
        unsafe extern "C" fn(
            cc: *mut *const br_aead_class,
            tag: *mut ::std::os::raw::c_void,
            len: usize,
    ...
    /// \param len   tag length (in bytes).
    /// \return  1 on success (exact match of tag value), 0 otherwise.
    pub check_tag_trunc: ::std::option::Option<
        unsafe extern "C" fn(
            cc: *mut *const br_aead_class,
            tag: *const ::std::os::raw::c_void,
            len: usize,
        ) -> u32,
    >,
}
...
pub struct br_gcm_context {
    ...
    pub j0_1: [::std::os::raw::c_uchar; 12usize],
...
pub struct br_eax_context {
    ...
    pub L2: [::std::os::raw::c_uchar; 16usize],
    pub L4: [::std::os::raw::c_uchar; 16usize],
    pub nonce: [::std::os::raw::c_uchar; 16usize],
    pub head: [::std::os::raw::c_uchar; 16usize],
    pub ctr: [::std::os::raw::c_uchar; 16usize],
    pub cbcmac: [::std::os::raw::c_uchar; 16usize],
    pub buf: [::std::os::raw::c_uchar; 16usize],
    pub ptr: usize,
}
...
pub struct br_eax_state {
    pub st: [[::std::os::raw::c_uchar; 16usize]; 3usize],
}
extern "C" {
...
pub struct br_ccm_context {
    ...
    pub ctr: [::std::os::raw::c_uchar; 16usize],
    pub cbcmac: [::std::os::raw::c_uchar; 16usize],
    pub tagmask: [::std::os::raw::c_uchar; 16usize],
    pub buf: [::std::os::raw::c_uchar; 16usize],
    pub ptr: usize,
    pub tag_len: usize,
}
...
/// \return  1 on success, 0 on error.
pub type br_rsa_public = ::std::option::Option<
    unsafe extern "C" fn(
...
/// \return  1 on success, 0 on error.
pub type br_rsa_pkcs1_vrfy = ::std::option::Option<
    unsafe extern "C" fn(
        x: *const ::std::os::raw::c_uchar,
        xlen: usize,
        hash_oid: *const ::std::os::raw::c_uchar,
        hash_len: usize,
        pk: *const br_rsa_public_key,
        hash_out: *mut ::std::os::raw::c_uchar,
    ) -> u32,
>;
...
/// \return  1 on success, 0 on error.
pub type br_rsa_private = ::std::option::Option<
    unsafe extern "C" fn(x: *mut ::std::os::raw::c_uchar, sk: *const br_rsa_private_key) -> u32,
>;
...
/// \return  1 on success, 0 on error.
pub type br_rsa_pkcs1_sign = ::std::option::Option<
    unsafe extern "C" fn(
        hash_oid: *const ::std::os::raw::c_uchar,
...
pub struct br_ec_impl {
    ...
    pub generator: ::std::option::Option<
        unsafe extern "C" fn(curve: ::std::os::raw::c_int, len: *mut usize)
    ...
    pub xoff: ::std::option::Option<
        unsafe extern "C" fn(curve: ::std::os::raw::c_int, len: *mut usize) -> usize,
    >,
...
pub type br_ecdsa_sign = ::std::option::Option<
    unsafe extern "C" fn(
        impl_: *const br_ec_impl,
        hf: *const br_hash_class,
        hash_value: *const ::std::os::raw::c_void,
...
/// \param sig_len    signature length (in bytes).
/// \return  1 on success, 0 on error.
pub type br_ecdsa_vrfy = ::std::option::Option<
    unsafe extern "C" fn(
        impl_: *const br_ec_impl,
...
pub struct br_x509_pkey {
    ...
    pub key_type: ::std::os::raw::c_uchar,
...
pub struct br_x509_class_ {
    ...
    pub start_chain: ::std::option::Option<
        unsafe extern "C" fn(
            ctx: *mut *const br_x509_class,
    ...
    pub start_cert:
        ::std::option::Option<unsafe extern "C" fn(ctx: *mut *const br_x509_class, length: u32)>,
    ...
    pub end_chain: ::std::option::Option<
        unsafe extern "C" fn(ctx: *mut *const br_x509_class) -> ::std::os::raw::c_uint,
    >,
    ...
    pub get_pkey: ::std::option::Option<
        unsafe extern "C" fn(ctx: *const *const br_x509_class, usages: *mut ::std::os::raw::c_uint)
            -> *const br_x509_pkey,
    >,
}
...
pub struct br_x509_minimal_context {
    ...
    pub key_usages: ::std::os::raw::c_uchar,
    pub days: u32,
    pub seconds: u32,
    pub cert_length: u32,
    pub num_certs: u32,
    pub hbuf: *const ::std::os::raw::c_uchar,
    pub hlen: usize,
    pub pad: [::std::os::raw::c_uchar; 256usize],
    pub ee_pkey_data: [::std::os::raw::c_uchar; 520usize],
    pub pkey_data: [::std::os::raw::c_uchar; 520usize],
    pub cert_signer_key_type: ::std::os::raw::c_uchar,
    pub cert_sig_hash_oid: u16,
    pub cert_sig_hash_len: ::std::os::raw::c_uchar,
    pub cert_sig: [::std::os::raw::c_uchar; 512usize],
    pub cert_sig_len: u16,
    pub min_rsa_size: i16,
    pub trust_anchors: *const br_x509_trust_anchor,
    pub trust_anchors_num: usize,
    pub do_mhash: ::std::os::raw::c_uchar,
    pub mhash: br_multihash_context,
    pub tbs_hash: [::std::os::raw::c_uchar; 64usize],
    pub do_dn_hash: ::std::os::raw::c_uchar,
    pub dn_hash_impl: *const br_hash_class,
    pub dn_hash: br_hash_compat_context,
    pub current_dn_hash: [::std::os::raw::c_uchar; 64usize],
    pub next_dn_hash: [::std::os::raw::c_uchar; 64usize],
    pub saved_dn_hash: [::std::os::raw::c_uchar; 64usize],
...
pub struct br_x509_minimal_context__bindgen_ty_1 {
    pub dp: *mut u32,
    pub rp: *mut u32,
    pub ip: *const ::std::os::raw::c_uchar,
}
extern "C" {
...
pub struct br_x509_decoder_context {
    ...
    pub err: ::std::os::raw::c_int,
    pub pad: [::std::os::raw::c_uchar; 256usize],
    pub decoded: ::std::os::raw::c_uchar,
    pub notbefore_days: u32,
    pub notbefore_seconds: u32,
    pub notafter_days: u32,
    pub notafter_seconds: u32,
    pub isCA: ::std::os::raw::c_uchar,
    pub copy_dn: ::std::os::raw::c_uchar,
    pub append_dn_ctx: *mut ::std::os::raw::c_void,
    pub append_dn: ::std::option::Option<
        unsafe extern "C" fn(
    ...
    pub hlen: usize,
    pub pkey_data: [::std::os::raw::c_uchar; 520usize],
    pub signer_key_type: ::std::os::raw::c_uchar,
    pub signer_hash_id: ::std::os::raw::c_uchar,
}
#[repr(C)]
...
extern "C" {
    ...
    pub fn br_x509_decoder_init(
        ...
        >,
        append_dn_ctx: *mut ::std::os::raw::c_void,
    );
}
extern "C" {
...
pub struct br_skey_decoder_context {
    ...
    pub pad: [::std::os::raw::c_uchar; 256usize],
    pub key_type: ::std::os::raw::c_uchar,
    pub key_data: [::std::os::raw::c_uchar; 1536usize],
}
#[repr(C)]
...
pub struct br_sslrec_in_class_ {
    ...
    pub check_length: ::std::option::Option<
        unsafe extern "C" fn(ctx: *const *const br_sslrec_in_class, record_len: usize)
            -> ::std::os::raw::c_int,
    >,
...
pub struct br_sslrec_out_class_ {
    ...
    pub max_plaintext: ::std::option::Option<
        unsafe extern "C" fn(
...
pub struct br_sslrec_in_cbc_class_ {
    ...
    pub init: ::std::option::Option<
        unsafe extern "C" fn(
            ...
            bc_key: *const ::std::os::raw::c_void,
            bc_key_len: usize,
            dig_impl: *const br_hash_class,
            mac_key: *const ::std::os::raw::c_void,
            mac_key_len: usize,
            mac_out_len: usize,
            iv: *const ::std::os::raw::c_void,
        ),
...
pub struct br_sslrec_in_cbc_context {
    ...
    pub explicit_IV: ::std::os::raw::c_int,
}
#[repr(C)]
...
pub struct br_sslrec_gcm_context {
    ...
    pub gh: br_ghash,
    pub iv: [::std::os::raw::c_uchar; 4usize],
    pub h: [::std::os::raw::c_uchar; 16usize],
}
/// \brief Pointer to vtable.
#[repr(C)]
pub union br_sslrec_gcm_context__bindgen_ty_1 {
    pub gen: *const ::std::os::raw::c_void,
...
pub struct br_ssl_session_parameters {
    ...
    /// \brief Master secret.
    pub master_secret: [::std::os::raw::c_uchar; 48usize],
}
...
pub struct br_ssl_engine_context {
    pub err: ::std::os::raw::c_int,
    pub ibuf: *mut ::std::os::raw::c_uchar,
    pub obuf: *mut ::std::os::raw::c_uchar,
    pub ibuf_len: usize,
    pub obuf_len: usize,
    pub max_frag_len: u16,
    pub log_max_frag_len: ::std::os::raw::c_uchar,
    pub peer_log_max_frag_len: ::std::os::raw::c_uchar,
    pub ixa: usize,
    pub ixb: usize,
    pub ixc: usize,
    pub oxa: usize,
    pub oxb: usize,
    pub oxc: usize,
    pub iomode: ::std::os::raw::c_uchar,
    pub incrypt: ::std::os::raw::c_uchar,
    pub shutdown_recv: ::std::os::raw::c_uchar,
    pub record_type_in: ::std::os::raw::c_uchar,
    pub record_type_out: ::std::os::raw::c_uchar,
    pub version_in: u16,
    pub version_out: u16,
    pub in_: br_ssl_engine_context__bindgen_ty_1,
    pub out: br_ssl_engine_context__bindgen_ty_2,
    pub application_data: ::std::os::raw::c_uchar,
    pub rng: br_hmac_drbg_context,
    pub rng_init_done: ::std::os::raw::c_int,
    pub rng_os_rand_done: ::std::os::raw::c_int,
    pub version_min: u16,
    pub version_max: u16,
    pub suites_buf: [u16; 40usize],
    pub suites_num: ::std::os::raw::c_uchar,
    pub server_name: [::std::os::raw::c_char; 256usize],
    ...
    pub ecdhe_curve: ::std::os::raw::c_uchar,
    pub ecdhe_point: [::std::os::raw::c_uchar; 133usize],
    pub ecdhe_point_len: ::std::os::raw::c_uchar,
    pub reneg: ::std::os::raw::c_uchar,
    pub saved_finished: [::std::os::raw::c_uchar; 24usize],
    pub flags: u32,
    pub cpu: br_ssl_engine_context__bindgen_ty_3,
    pub dp_stack: [u32; 32usize],
    pub rp_stack: [u32; 32usize],
    pub pad: [::std::os::raw::c_uchar; 512usize],
    pub hbuf_in: *mut ::std::os::raw::c_uchar,
    pub hbuf_out: *mut ::std::os::raw::c_uchar,
    pub saved_hbuf_out: *mut ::std::os::raw::c_uchar,
    pub hlen_in: usize,
    pub hlen_out: usize,
    pub hsrun: ::std::option::Option<unsafe extern "C" fn(ctx: *mut ::std::os::raw::c_void)>,
    pub action: ::std::os::raw::c_uchar,
    pub alert: ::std::os::raw::c_uchar,
    pub close_received: ::std::os::raw::c_uchar,
    pub mhash: br_multihash_context,
    pub x509ctx: *mut *const br_x509_class,
    pub chain: *const br_x509_certificate,
    pub chain_len: usize,
    pub cert_cur: *const ::std::os::raw::c_uchar,
    pub cert_len: usize,
    pub protocol_names: *mut *const ::std::os::raw::c_char,
...
extern "C" {
    ...
    pub fn br_ssl_engine_set_buffer(
        cc: *mut br_ssl_engine_context,
        iobuf: *mut ::std::os::raw::c_void,
        iobuf_len: usize,
        bidi: ::std::os::raw::c_int,
    );
}
extern "C" {
...
pub struct br_ssl_client_certificate_class_ {
    ...
    pub start_name_list: ::std::option::Option<
    ...
    pub start_name: ::std::option::Option<
    ...
    pub append_name: ::std::option::Option<
        unsafe extern "C" fn(
    ...
    ///
    /// \param pctx   certificate handler context.
    pub end_name: ::std::option::Option<
        unsafe extern "C" fn(pctx: *mut *const br_ssl_client_certificate_class),
    >,
    ...
    ///
    /// \param pctx   certificate handler context.
    pub end_name_list: ::std::option::Option<
        unsafe extern "C" fn(pctx: *mut *const br_ssl_client_certificate_class),
    >,
...
pub struct br_ssl_client_certificate_ec_context {
    ...
    pub allowed_usages: ::std::os::raw::c_uint,
...
pub struct br_ssl_client_context_ {
    ...
    pub hashes: u32,
    pub server_curve: ::std::os::raw::c_int,
    pub client_auth_vtable: *mut *const br_ssl_client_certificate_class,
    pub auth_type: ::std::os::raw::c_uchar,
    pub hash_id: ::std::os::raw::c_uchar,
...
extern "C" {
    ...
    pub fn br_ssl_client_reset(
        cc: *mut br_ssl_client_context,
        server_name: *const ::std::os::raw::c_char,
        resume_session: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn br_ssl_client_set_single_ec(
        ...
        chain_len: usize,
        sk: *const br_ec_private_key,
        allowed_usages: ::std::os::raw::c_uint,
        cert_issuer_key_type: ::std::os::raw::c_uint,
...
pub struct br_ssl_session_cache_lru {
    ...
    pub store: *mut ::std::os::raw::c_uchar,
    pub store_len: usize,
    pub store_ptr: usize,
    pub index_key: [::std::os::raw::c_uchar; 32usize],
...
pub struct br_ssl_server_context_ {
    ...
    pub client_suites_num: ::std::os::raw::c_uchar,
    pub hashes: u32,
    pub curves: u32,
...
pub struct br_sslio_context {
    ...
    pub low_read: ::std::option::Option<
        unsafe extern "C" fn(
            read_context: *mut ::std::os::raw::c_void,
            data: *mut ::std::os::raw::c_uchar,
            len: usize,
        ) -> ::std::os::raw::c_int,
    >,
    pub read_context: *mut ::std::os::raw::c_void,
    pub low_write: ::std::option::Option<
        unsafe extern "C" fn(
            write_context: *mut ::std::os::raw::c_void,
            data: *const ::std::os::raw::c_uchar,
            len: usize,
        ) -> ::std::os::raw::c_int,
    >,
    pub write_context: *mut ::std::os::raw::c_void,
}
extern "C" {
...
pub struct br_pem_decoder_context {
    ...
    pub hbuf: *const ::std::os::raw::c_uchar,
    pub hlen: usize,
    pub dest: ::std::option::Option<
        unsafe extern "C" fn(
            dest_ctx: *mut ::std::os::raw::c_void,
            src: *const ::std::os::raw::c_void,
            len: usize,
        ),
    >,
    pub dest_ctx: *mut ::std::os::raw::c_void,
    pub event: ::std::os::raw::c_uchar,
    pub name: [::std::os::raw::c_char; 128usize],
    pub buf: [::std::os::raw::c_uchar; 255usize],
    pub ptr: usize,
}
#[repr(C)]
