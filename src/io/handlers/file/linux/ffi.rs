//bindgen --with-derive-default --whitelist-function="io_getevents|io_setup|io_destroy|io_submit|memfd_create" --no-layout-tests --whitelist-var="IOCB_CMD_PREAD|IOCB_FLAG_RESFD" src/io/handlers/file/linux/aio.h
